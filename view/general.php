<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $wsap_msg = validate("msg", FILTER_SANITIZE_SPECIAL_CHARS);
...
<div class="container pt-5">
  <div class="text-center mb-4">
    ...
    <h2 class="title"><?php echo $configration->R_name;?></h2>
  </div>
  <div class="card info-container text-center">
    <div class="card-body">
      <p class="card-text text-dark mb-4">you can edit your information from here.</p>
      <form class="form" method="POST" action="<?php echo M_URL . "general";?>" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input
                ...
                value="<?php echo isset($configration->R_number) ? $configration->R_number: "";?>">
        </div>
        <div class="form-group">
          ...
          <input
                ...
                value="<?php echo isset($configration->R_whatsapp) ? $configration->R_whatsapp: "";?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input
                ...
                name="address"
                placeholder="address"
                value="<?php echo isset($configration->R_address) ? $configration->R_address: "";?>">
        </div>
        <div class="form-group">
          <label for="currency">currency</label>
          <select name="currency" id="currency" class="form-control">
            <?php foreach ($currencies as $currency):?>
              <option <?php echo $currency->id == $configration->R_currency ? "selected": "";?> value="<?php echo $currency->id;?>"><?php echo $currency->icon;?> -- <?php echo $currency->name;?></option>
            <?php endforeach;?>
          </select>
        </div>
