		...
		<div class="row">
			<div class="col-lg-4">
				<div class="tm-feature">
					...
					<a href="index" class="tm-btn tm-btn-primary">Read More</a>
				</div>
			</div>
			<div class="col-lg-4">
				<div class="tm-feature">
					...
					<a href="index" class="tm-btn tm-btn-success">Read More</a>
				</div>
			</div>
			<div class="col-lg-4">
				<div class="tm-feature">
					...
					<a href="index" class="tm-btn tm-btn-danger">Read More</a>
				</div>
			</div>
		</div>
	</div>
